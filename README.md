...
| 上游基线 | `v0.1.171` / `f0e7a9c7a23a7d02fb159b62fa809621eb0475a6` |
| 上游升级标签 | `v0.1.171` |
...
```bash
git diff v0.1.171..HEAD
```

## 上游 v0.1.171 文档与功能

本仓库以这份 README 作为 4Sub2 私有功能和团队协作的主说明。同步 `v0.1.171` 时，
...
`v0.1.171` 增加腾讯天御与阿里云验证码 2.0、分组利润控制、账号上游倍率探测与同步、
内容审核代理、筛选结果全选与并发批量删除、compact home 等能力，并包含 Codex、Grok、
订阅额度窗口、支付方式、模型广场和 WebSocket 转发修复。新开关沿用上游安全默认值；
