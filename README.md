...
| 上游基线 | `v0.1.169` / `26d894ef4f50645a4bf1030e378ac892f17d0223` |
| 上游升级标签 | `v0.1.169` |
...
```bash
git diff v0.1.169..HEAD
```

## 上游 v0.1.169 文档与功能

本仓库以这份 README 作为 4Sub2 私有功能和团队协作的主说明。同步 `v0.1.169` 时，
...
`v0.1.164` 引入、并在 `v0.1.169` 基线中继续保留的组合分组能力已纳入本次同步。管理员可以
使用组合分组将请求模型解析到具体供应商，完整运维说明见
[`docs/COMPOSITE_GROUPS.md`](docs/COMPOSITE_GROUPS.md)。本次上游 README 变更仅清理合作伙伴
条目；公共功能、安装和配置说明继续以同步后的多语言说明为准。
