export default {
    ops: {
      ...
      hermes: {
        title: 'Hermes 配额恢复状态',
        description: '查看 Hermes 巡检任务的生命周期、租约健康度和最近一次汇总结果。',
        backToOps: '返回运维监控',
        refresh: '刷新',
        refreshing: '刷新中…',
        autoRefresh: '每 15 秒自动刷新',
        lastFetched: '状态获取于 {time}',
        loading: '正在加载 Hermes 状态…',
        loadFailed: '加载 Hermes 状态失败',
        retry: '重试',
        noSnapshot: '暂时没有可用的 Hermes 状态快照。',
        sinceStartup: '运行观测数据保存在内存中，从当前进程启动后开始统计。',
        status: {
          healthy: '正常',
          warning: '需要关注',
          error: '异常',
        ...
        runtimeTitle: '运行状态',
        leaseTimeline: '租约时间线',
        runtimeSection: 'Hermes 运行状态',
        runsSection: 'Hermes 巡检汇总',
        lifecycle: '生命周期',
        lease: '分布式租约',
        leaseHeld: '已持有',
        leaseNotHeld: '未持有',
        ...
        startedAt: '工作进程启动时间',
        nextRunAt: '下次巡检',
        lastLeaseAcquiredAt: '最近获得租约',
        lastLeaseLostAt: '最近失去租约',
        lastReacquiredAt: '最近重新获得租约',
        configuration: '生效配置',
        interval: '巡检间隔',
        batchSize: '批次大小',
        concurrency: '并发数',
        ...
        seconds: '{value}s',
        currentRun: '当前巡检',
        currentRunHint: 'Hermes 当前正在执行巡检。',
        lastRun: '最近完成的巡检',
        noCurrentRun: '当前没有正在进行的巡检。',
        noLastRun: '进程启动后还没有完成过巡检。',
        trigger: '触发方式',
        runStartedAt: '开始时间',
        runCompletedAt: '完成时间',
        listed: '列出',
        ...
        lastError: '最近错误',
        notAvailable: '暂无',
        healthyHint: '工作进程已启用、持有租约，并且正在正常上报状态。',
        disabledHint: 'Hermes 在当前生效配置中未启用。',
        warningHint: '工作进程已启用但需要关注，请检查租约和最近巡检详情。',
        errorHint: '工作进程报告了错误或失去了租约。'
      },
      systemLogs: {
        title: '系统日志',
