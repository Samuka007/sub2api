export default {
  dashboard: {
    ...
    greeting: '你好，{name}',
    workspaceSummary: '查看 API 用量、平台配额和最近请求。',
    balance: '余额',
    availableBalanceHint: '当前可用余额',
    apiKeys: 'API 密钥',
    activeKeysHint: '{count} 个密钥正在使用',
    todayRequests: '今日请求',
    totalRequestsHint: '累计 {count} 次请求',
    todayCost: '今日消费',
    standardCostHint: '标准计费 ${amount}',
    ...
    granularity: '粒度',
    usageAnalysis: '用量分析',
    usageAnalysisDescription: 'Token 使用趋势与高频模型',
    day: '按天',
    hour: '按小时',
    topModels: '高频模型',
    ...
    platformTotalCost: '累计消费',
    platformQuotaOverview: '平台配额',
    platformQuotaDescription: '优先展示最短计费窗口',
    todayShort: '今日',
    ...
    cache: '缓存',
    recentUsage: '最近使用',
    recentUsageDescription: '最新 API 请求及实际计费',
    last7Days: '近 7 天',
    time: '时间',
    requestMode: '请求模式',
    duration: '耗时',
