export default {
  dashboard: {
    ...
    greeting: 'Hello, {name}',
    workspaceSummary: 'Review API usage, platform quotas, and recent requests.',
    balance: 'Balance',
    availableBalanceHint: 'Currently available',
    apiKeys: 'API Keys',
    activeKeysHint: '{count} keys active',
    todayRequests: 'Today Requests',
    totalRequestsHint: '{count} requests in total',
    todayCost: 'Today Cost',
    standardCostHint: 'Standard billing ${amount}',
    ...
    usageAnalysisDescription: 'Token trends and frequently used models',
    day: 'Day',
    hour: 'Hour',
    ...
    platformTotalCost: 'Total spend',
    platformQuotaOverview: 'Platform quotas',
    platformQuotaDescription: 'Showing the shortest configured window',
    todayShort: 'today',
    ...
    recentUsageDescription: 'Latest API requests and actual billing',
