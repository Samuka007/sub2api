export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for SCIbuddy end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for SCIbuddy end-user login',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve billing rates declared by upstream SCIbuddy sites for supported API Key accounts. Account rates change only when the separate sync switch is enabled.',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on SCIbuddy orders; the upstream type is sent as EasyPay type.',
