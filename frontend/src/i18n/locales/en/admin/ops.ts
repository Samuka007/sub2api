export default {
    ops: {
      ...
      hermes: {
        title: 'Hermes quota-recovery status',
        description: 'Inspect the Hermes worker lifecycle, lease health, and latest aggregate run results.',
        backToOps: 'Back to Ops monitoring',
        refresh: 'Refresh',
        refreshing: 'Refreshing…',
        autoRefresh: 'Auto-refresh every 15 seconds',
        lastFetched: 'Status fetched at {time}',
        loading: 'Loading Hermes status…',
        loadFailed: 'Failed to load Hermes status',
        retry: 'Retry',
        noSnapshot: 'No Hermes status snapshot is available yet.',
        sinceStartup: 'Runtime observations are held in memory and start with this process.',
        status: {
          healthy: 'Healthy',
        ...
        runtimeSection: 'Hermes runtime status',
        runsSection: 'Hermes run summaries',
        lifecycle: 'Lifecycle',
        lease: 'Advisory lease',
        leaseHeld: 'Held',
        leaseNotHeld: 'Not held',
        leaseHealthy: 'Healthy',
        leaseUnhealthy: 'Unhealthy',
        enabled: 'Enabled',
        disabled: 'Disabled',
        observedAt: 'Observed at',
        startedAt: 'Worker started at',
        nextRunAt: 'Next run',
        lastLeaseAcquiredAt: 'Last lease acquired',
        lastLeaseLostAt: 'Last lease lost',
        lastReacquiredAt: 'Last lease reacquired',
        ...
        currentRunHint: 'A Hermes scan is currently in progress.',
        lastRun: 'Last completed run',
        noCurrentRun: 'No run is currently in progress.',
        noLastRun: 'No completed run has been observed since startup.',
        trigger: 'Trigger',
        ...
        casMisses: 'CAS misses',
        errors: 'Errors',
        duration: 'Duration',
        milliseconds: '{value} ms',
        lastError: 'Last error',
        notAvailable: 'Not available',
        healthyHint: 'The worker is enabled, holds its lease, and is reporting normally.',
        disabledHint: 'Hermes is disabled in the effective runtime configuration.',
        warningHint: 'The worker is enabled but needs attention; inspect lease and latest run details.',
        errorHint: 'The worker reported an error or lost its lease.'
      },
      systemLogs: {
        title: 'System Logs',
