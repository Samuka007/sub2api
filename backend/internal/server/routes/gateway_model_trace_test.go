	...
	manifest := []struct {
		...
		},
		{
			...
			routes: []modelTraceRouteKey{
				...
				{http.MethodGet, "/v1/custom-voices/:voice_id/audio"},
				{http.MethodGet, "/v1/custom-voices/:voice_id"},
				{http.MethodPatch, "/v1/custom-voices/:voice_id"},
				{http.MethodDelete, "/v1/custom-voices/:voice_id"},
				...
				{http.MethodGet, "/v1/videos/edits/:request_id"},
				{http.MethodGet, "/v1/videos/edits/:request_id/content"},
				{http.MethodGet, "/v1/videos/extensions/:request_id"},
				{http.MethodGet, "/v1/videos/extensions/:request_id/content"},
				{http.MethodGet, "/v1beta/models"},
				{http.MethodGet, "/v1beta/models/:model"},
				{http.MethodGet, "/models"},
				{http.MethodGet, "/backend-api/codex/:call_id"},
				...
				{http.MethodGet, "/custom-voices/:voice_id/audio"},
				{http.MethodGet, "/custom-voices/:voice_id"},
				{http.MethodPatch, "/custom-voices/:voice_id"},
				{http.MethodDelete, "/custom-voices/:voice_id"},
				{http.MethodGet, "/realtime"},
				{http.MethodGet, "/videos/generations/:request_id"},
				{http.MethodGet, "/videos/generations/:request_id/content"},
				{http.MethodGet, "/videos/edits/:request_id"},
				{http.MethodGet, "/videos/edits/:request_id/content"},
				{http.MethodGet, "/videos/extensions/:request_id"},
				{http.MethodGet, "/videos/extensions/:request_id/content"},
