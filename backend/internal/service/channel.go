...
type ChannelModelPricing struct {
	...
	ReferenceMultiplier          *float64            `json:"reference_multiplier,omitempty"` // Display-only multiplier relative to official pricing
	ReferenceSource              string              `json:"reference_source,omitempty"`     // Display-only multiplier source
