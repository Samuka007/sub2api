...
// codexIdentityEnforcement 控制出站 User-Agent 与 version 是否强制统一。
// codexOriginatorNormalization 单独控制 originator 是否按最终 User-Agent 重写。
// 两个开关均默认开启，避免零值配置静默关闭保护。
...
// SetCodexOriginatorNormalizationEnabled 发布 originator 规范化开关。
